...
<main id="main" class="main">
    ...
    <div class="row py-2">
        <div class="col-4 text-center">
            <a href="{{ route('techer.index') }}" class="btn btn-success w-100"><i class="bi bi-people"></i> Aktiv o'qituvchilar</a>
        </div>
        <div class="col-4 text-center">
            <a href="{{ route('techerLock') }}" class="btn btn-danger w-100"><i class="bi bi-person-lock"></i> Bloklangan o'qituvchilar</a>
        </div>
        <div class="col-4 text-center">
            <a href="{{ route('techer.create') }}" class="btn btn-primary w-100"><i class="bi bi-person-plus"></i> Yangi o'qituvchi</a>
        </div>
    </div>
