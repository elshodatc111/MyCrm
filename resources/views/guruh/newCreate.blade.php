    ...
    @endif
        ...
        <div class="card">
            <div class="card-body pt-4 text-center">
                <h5>Yangi guruh</h5>
                <form action="{{ route('NewGuruhUpdate')  }}" method="post" id="form">
                    @csrf
                    @method('put')
                    <div class="row">
                        <div class="col-lg-3">
                        ...
                        <div class="col-lg-3">
                            <label for="guruh_dars_vaqt" class="mt-4">Talabalar</label>
                            <div class="row py-3" style="border:1px solid blue">
                                @foreach($Javob['Talaba'] as $item )
                                        <p class="p-0 m-1">{{ $item['name'] }}</p>
                                @endforeach
                            </div>
                        </div>
